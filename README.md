...
git clone --recursive https://github.com/ben-mansor/muDCN.git
...
1. Go to the [Issues](https://github.com/ben-mansor/muDCN/issues) tab
2. Click "New Issue"
...
git remote add upstream https://github.com/ben-mansor/muDCN.git
